...
#'       DO.mod.1          \tab numeric         \tab mgO2 L^-1          \tab optional      
#'     }
#'     
#'     \strong{Example}:
#'     \tabular{lrrrrrrr}{
#'       \code{date      } \tab \code{K600.daily} \tab \code{GPP.daily} \tab \code{Pmax} \tab \code{alpha} \tab \code{ER.daily} \tab \code{ER20} \tab \code{DO.mod.1}\cr
#'       \code{2050-03-14} \tab \code{10        } \tab \code{5        } \tab \code{10  } \tab \code{1e-04} \tab \code{-10     } \tab \code{-10 } \tab \code{7.5     }
#'     }
#'   }
#' }
