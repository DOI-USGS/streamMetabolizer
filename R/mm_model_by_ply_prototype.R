...
#'   observation time.
#' @param solar_date the modal date of this ply of data and data_daily, and the 
#'   date by which this ply should be referred
#' @export
mm_model_by_ply_prototype <- function(data_ply, data_daily_ply, ..., day_start, day_end, solar_date) {
