  ...
  model_text <- c(
    ...
    indent(
      ...
      if(pool_K600 %in% c('none')) s(
        ...
        'K600_daily ~ ', f('lognormal', meanlog='K600_daily_pred', sdlog='K600_daily_sdlog')
      )
    ),
    ...
    if(pool_K600 != 'none') c(
      ...
      indent(
        ...
        switch(
          pool_K600,
          'normal' = c(
            s('K600_daily_pred ~ ', f('lognormal', meanlog='K600_daily_meanlog_meanlog', sdlog='K600_daily_meanlog_sdlog '))
          ),
          'linear' = c(
