...
ggplot(beaty_creek_tidy, aes(x=date.time, y=value)) + geom_point(size=0.5) + facet_grid(variable~., scales="free_y") + theme_bw()
```
...
ggplot(beaty_creek_tiny, aes(x=date.time, y=value)) + geom_point(size=0.5) + facet_grid(variable~., scales="free_y") + theme_bw()
```
