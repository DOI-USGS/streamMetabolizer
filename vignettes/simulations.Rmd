...
```{r}
specs_sim_q10 <- specs(name_sim_q10, err_obs_sigma=0, err_proc_sigma=1)
specs_sim_q10
```
...
```{r}
specs_sim_sat <- specs(mm_name('sim', GPP_fun='satlight'), err_obs_sigma=0, err_proc_sigma=1)
...
specs <- specs(mm_name('sim', GPP_fun='satlight', ER_fun='q10temp'), err_obs_sigma=0.2, err_proc_sigma=1)
