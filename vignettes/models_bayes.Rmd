...
The structure and specifications of Bayesian models require special attention. We'll add more to this section later, but for now, please spend lots of time reading the help file at `?specs`, especially the `Relevant arguments` section and the parameter definitions.
