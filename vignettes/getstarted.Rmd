...
default MLE model). The full list of model options this way (we'll just print a
sampling of the full list):

```{r, results='asis'}
valid_names <- mm_valid_names(type=c('bayes','mle','night'))
length(valid_names)
valid_names[seq(1,length(valid_names),length.out=20)]
```
