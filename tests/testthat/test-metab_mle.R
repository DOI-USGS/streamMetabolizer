...
test_that("metab_mle predictions (predict_metab, predict_DO) make sense", {
  ...
  mmE <- metab_mle(data=vfrenchshort, day_start=-1, day_end=23, model_specs=specs_mle_nopool_oi(ODE_method="Euler"))
  mmP <- metab_mle(data=vfrenchshort, day_start=-1, day_end=23, model_specs=specs_mle_nopool_oi(ODE_method="pairmeans"))
