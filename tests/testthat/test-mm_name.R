...
test_that("mm_name can generate names", {
  # missing args OK
  expect_equal(mm_name(), "m_np_oi_pm_plrckm.nlm")
  expect_equal(mm_name('bayes'), "b_np_oipi_pm_plrckm.stan")
  expect_equal(mm_name('m'), "m_np_oi_pm_plrckm.nlm") # even abbreviations work! lazy, though
  expect_equal(mm_name('sim'), "s_np_oipcpi_pm_plrckm.rnorm")
  expect_equal(mm_name('Kmodel'), "K_Kc___.lm")
  expect_equal(mm_name('b', pool_K600='none'), "b_np_oipi_pm_plrckm.stan")
  expect_equal(mm_name('b', pool_K600='none', err_proc_acor=TRUE), "b_np_oipcpi_pm_plrckm.stan")
...
test_that("mm_parse_name can parse names", {
  ...
  expect_equal(dim(mm_parse_name("m_np_oi_pm_km.nlm")), c(1,10))
  ...
  expect_equal(do.call(mm_name, mm_parse_name("b_np_oipi_pm_plrckm.stan")), "b_np_oipi_pm_plrckm.stan")
